...
exports.DirectedStakeWrapper = void 0;
...
class DirectedStakeWrapper {
    ...
    static async fromData({ sdk, address, data, }) {
        ...
        return new DirectedStakeWrapper(sdk, address, data);
    }
    /**
     ...
     */
    async reload() {
        return (this.data = await DirectedStakeWrapper.loadData({
            sdk: this.sdk,
    ...
    static voteRecordAddress({ sdk, root, owner, }) {
        return DirectedStakeWrapper.calculateVoteRecordAddress({
    ...
    getVoteRecordAddress(owner) {
        return DirectedStakeWrapper.voteRecordAddress({
            sdk: this.sdk,
            root: this.address,
            owner,
        })[0];
    ...
    async getVoteRecord(owner) {
        ...
        const data = await DirectedStakeWrapper.getVoteRecord({
            sdk: this.sdk,
            address,
        });
        return { address, data };
...
exports.DirectedStakeWrapper = DirectedStakeWrapper;
//# sourceMappingURL=DirectedStake.js.map